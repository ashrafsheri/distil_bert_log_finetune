  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 px-5 py-2.5 glass-strong hover:bg-vt-primary/20 rounded-xl border border-vt-primary/30 transition-all text-vt-light shadow-lg hover:shadow-vt-primary/30 hover:scale-105"
      >
      ...
      {/* Settings Panel */}
      {isOpen && (
        <div className="absolute right-0 mt-3 w-96 glass-strong rounded-2xl border border-vt-primary/30 shadow-2xl z-50 p-6 animate-slide-down">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-vt-primary to-vt-success rounded-xl flex items-center justify-center shadow-lg">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
                </svg>
              </div>
              <h3 className="text-lg font-bold text-vt-light">Detection Thresholds</h3>
            </div>
            <button
              onClick={() => setIsOpen(false)}
              className="text-vt-muted hover:text-vt-light hover:bg-vt-primary/10 rounded-lg p-2 transition-all"
            >
