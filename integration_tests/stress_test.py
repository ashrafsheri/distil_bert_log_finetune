...
ORGS = [
    {
        "name":    "SaaS Starter",
        "api_key": os.getenv("SAAS_API_KEY", "sk-cFJiwE-O7Cau_HJx0dYVo0dlXFjWzcUADvH_zyzy0fE"),
        "site":    "http://152.70.28.154",       # just used in fake log Host header
    },
    {
        "name":    "Playground",
        "api_key": os.getenv("PLAYGROUND_API_KEY", "sk-DbGKGlaYfZLAel-VhO6REacddgPrf8oU5sP8tz18AJg"),
