...
- LogGuard server accessible (127.0.0.1:80)
...
# Test connectivity
curl -v http://127.0.0.1/api/v1/logs/agent/send-logs \
  -H "X-API-Key: sk-replace-with-project-ingest-api-key" \
  -d '[]'
```
