...
- **Volume Mount**: Already configured in `docker-compose.yml`
  ...
  ```
- **Host Directory**: `/home/ubuntu/logguard/realtime_anomaly_detection/logs`
...
```bash
ls -lh /home/ubuntu/logguard/realtime_anomaly_detection/logs/
```
...
### View container logs:
```bash
sudo docker logs logguard_anomaly-detection_1
```
